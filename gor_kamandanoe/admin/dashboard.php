...
<div class="page-body">
  <p class="text-muted welcome-banner" style="font-size:13px;margin-bottom:22px;">Selamat datang kembali, 
    <strong class="text-dark"><?= htmlspecialchars($_SESSION['nama']) ?></strong>!</p>
