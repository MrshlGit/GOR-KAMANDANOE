  ...
  <div class="topbar">
    ...
    <div class="topbar-right">
      <div class="topbar-search">
        <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#8a8680" stroke-width="2"
...
=======
>>>>>>> dff7f95ec0596171fa135e7b8076eee1a45e6e6e
  </div>

  <div class="page-body">
    <p class="text-muted welcome-banner" style="font-size:13px;margin-bottom:22px;">Selamat datang kembali, <strong
        class="text-dark"><?= htmlspecialchars($_SESSION['nama']) ?></strong>!</p>
      ...
      <div class="card-box">
        ...
        <div style="padding:8px 0;">
          ...
          foreach ($lapangans as $lap):
            ...
            ?>
            <div class="two-col"
              style="align-items:center;justify-content:space-between;padding:12px 20px;border-bottom:1px solid var(--border);">
